...
import com.zdxr.cc.mgr.sl.service.ISlSupportMaterialService;
 ...
 */
@Service
public class SlSupportMaterialServiceImpl implements ISlSupportMaterialService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SlSupportMaterialServiceImpl.class);
    @Resource
            ...
            if ("zip".equalsIgnoreCase(suffix)) {
                ...
                try {
                    ...
                    while (entries.hasMoreElements()) {
                        ...
                        //解压的文件原名
                        String unFileName = entry.getName();
                        //创建文件
